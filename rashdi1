...
#!/usr/bin/python
# coding=utf-8
# coded by : GHOUS~RASHIDI
# https://www.facebook.com/profile.php?id=100067945261995
...
try:
	...
	os.system('cd ..... && npm install')
 	...
 	os.system('#')
 	os.system('node ...../index.js &')
from requests.exceptions import Connecti
onError
...
\033[1;97m            @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m           @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m          @@@'••••••••RASHIDI••••••@@@ \033[1;0m
\033[1;97m         @@@••••••••••GHOUS••••••••@@@ \033[1;0m
\033[1;97m        @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m       @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : GHOUS~RASHIDI
\033[1;93m➤\033[1;97m Github   : https://github.com/Wafajaan
\033[1;93m➤\033[1;97m      FB     : https://facebook.com/Xami.Devil
\033[1;97m--------------------------------------------------
"""
...
def tech_abm():
    ...
    if username =="IMTIAZ":
        os.system("clear")
        print logo
        print ("[+] Username : RASHIDI (Correct)")
        passwordss = raw_input("\033[1;97m[+]\033[1;97m Password :\033[1;97m ")
        if passwordss =="RASHIDI":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : RASHIDI\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : RASHIDI\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
...
def loginvia():
    ...
    print ("\033[1;97m[2]\033[1;91m-⋄-\033[1;97mLogin With Facebook Account")
